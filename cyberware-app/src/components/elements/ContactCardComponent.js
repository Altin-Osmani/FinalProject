...
export default function ContactCardComponent(props) {
  return (
    <div className="relative w-full max-w-sm my-16 md:my-10 ">
      {/* Image Section */}
      ...
      <button className="absolute -bottom-20 left-4 w-12 h-12 bg-cyberorange rounded-full flex justify-center items-center">
        <svg
         className="w-8"
          viewBox="0 0 44 44"
          fill="none"

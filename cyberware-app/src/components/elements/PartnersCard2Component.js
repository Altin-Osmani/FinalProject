...
export default function PartnersCard2Component(props) {
  return (
    <>
    <div className="bg-cyberslate p-8"> 
        <div className="flex  flex-col md:flex-row md:items-stretch space-x-0 md:space-x-8 space-y-8 md:space-y-0 ">
